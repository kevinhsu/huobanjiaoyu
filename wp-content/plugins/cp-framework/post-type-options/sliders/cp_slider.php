...
if(class_exists('function_library')){
	...
	class cp_slider_class extends function_library{
		...
		public function add_slider_option(){
			...
			add_meta_box('cp_slider_option', __('Slider Images','crunchpress'), array( $this, 'add_slider_option_element' ),
					...
					<div class="meta-input-slider">
						<div class="image-picker" id="image-picker">
							...
							<div class="selected-image" id="selected-image">
								<div id="selected-image-none"><?php esc_html_e('No Image Inserted', 'crunchpress'); ?></div>
								<ul>
									<li id="default" class="default">
										...
										<div class="meta-title meta-detail-title"><?php esc_html_e('SLIDER TITLE', 'crunchpress'); ?></div> 
											<div class="meta-detail-input meta-input"><input type="text" id='<?php echo esc_attr($name['title']); ?>' /></div><br class="clear">
											<hr class="separator">
											<div class="meta-title meta-detail-title"><?php esc_html_e('SLIDER CAPTION', 'crunchpress'); ?></div>
											...
											<div class="url">
												...
												<div class="meta-detail-input meta-input"><input class="mt10" type="text"  id='<?php echo esc_attr($name['link']); ?>' /></div>
											</div>
											<hr class="separator">
											...
											foreach ($value->childNodes as $slider){ ?> 
												...
												<li class="slider-image-init">
													...
													<div id="slider-detail" class="slider-detail">
														...
														<div class="url">
															<div class="meta-title meta-detail-title" rel="url"><?php esc_html_e('URL PATH', 'crunchpress'); ?></div> 
															<div class="meta-detail-input meta-input"><input class="mt10" type="text" name='<?php echo esc_attr($name['link']); ?>[]' id='<?php echo esc_attr($name['link']); ?>[]' value="<?php echo esc_url(find_xml_value($slider, 'link')); ?>" /></div>
														</div>
														<div class="clear"></div>
														<!--<div class="meta-title meta-detail-title"><?php esc_html_e('BUTTON TEXT', 'crunchpress'); ?></div> 

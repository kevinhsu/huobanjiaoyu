	...
	class cp_gallery_class extends function_library{
		...
		'image_icon' =>array(
			...
			'item-size'=>array(
				...
				'options'=> array('Catalogue View','2 Column', '3 Column', '4 Column')
		...
		public function add_gallery_option(){
			...
			add_meta_box('gallery-option', __('Gallery','crunchpress'), array($this,'add_gallery_option_element'),
				'gallery', 'normal', 'high');
					...
					<div class="meta-input-slider">
						<div class="image-picker" id="image-picker">
							...
							<div class="selected-image" id="selected-image">
								<div id="selected-image-none"><?php esc_html_e('No Gallery Items Inserted','crunchpress');?></div>
								<ul>
									<li id="default" class="default">
										...
										<div id="slider-detail" class="slider-detail"> 	<br class="clear">
											<div class="meta-title meta-detail-title"><?php esc_html_e('Title', 'crunchpress'); ?></div> 
											<div class="meta-detail-input meta-input"><input type="text" id='<?php echo esc_attr($name['title']); ?>' /></div>
											<hr class="separator"><br class="clear">
											<div class="meta-title meta-detail-title"><?php esc_html_e('Image Caption', 'crunchpress'); ?></div>
											<div class="meta-input meta-detail-input"><textarea id='<?php echo esc_attr($name['caption']); ?>' ></textarea></div><hr class="separator"><br class="clear">
											<div class="meta-title meta-detail-title"><?php esc_html_e('Link Type', 'crunchpress'); ?></div> 
											<div class="meta-input meta-detail-input">
												<div class="combobox">
													<select id='<?php echo esc_attr($name['linktype']); ?>'>
														<option><?php esc_html_e('No Link','crunchpress');?></option>
														<option selected><?php _e('Lightbox','crunchpress');?></option>
														<option><?php esc_html_e('Link to URL','crunchpress');?></option>	
														<option><?php esc_html_e('Video','crunchpress');?></option>
													</select>
												</div>
											</div><br class="clear">
											<div class="url">
												<div class="meta-title meta-detail-title" rel="url"><?php esc_html_e('URL Path', 'crunchpress'); ?></div> 
												<div class="meta-input meta-detail-input"><input class="mt10" type="text"  id='<?php echo esc_attr($name['link']); ?>' /></div><br class="clear">
											</div>
											<div class="video">
												<div class="meta-title meta-detail-title" rel="embed"><?php esc_html_e('Video URL', 'crunchpress'); ?></div> 
												<div class="meta-input meta-detail-input"><input class="mt10" type="text"  id='<?php echo esc_attr($name['video']); ?>' /></div><br class="clear">
											</div>	
											<br class="clear">
										...
										if(!empty($value)){
											...
											foreach ($value->childNodes as $slider){ ?> 
												...
												<li class="slider-image-init">
													...
													<input type="hidden" class='slider-image-url' name='<?php echo esc_attr($name['image']); ?>[]' id='<?php echo esc_attr($name['image']); ?>[]' value="<?php echo esc_attr(find_xml_value($slider, 'image')); ?>" /> 
													<div id="slider-detail-wrapper" class="slider-detail-wrapper">
													<div id="slider-detail" class="slider-detail">								
														<div class="meta-title meta-detail-title"><?php esc_html_e('Title', 'crunchpress'); ?></div> 
														<div class="meta-detail-input meta-input"><input type="text" name='<?php echo esc_attr($name['title']); ?>[]' id='<?php echo esc_attr($name['title']); ?>[]' value="<?php echo esc_attr(find_xml_value($slider, 'title')); ?>" /></div><br class="clear">
														<hr class="separator">
														<div class="meta-title meta-detail-title"><?php esc_html_e('Image Caption', 'crunchpress'); ?></div>
														<div class="meta-detail-input meta-input"><textarea name='<?php echo esc_attr($name['caption']); ?>[]' id='<?php echo esc_attr($name['caption']); ?>[]' ><?php echo esc_attr(find_xml_value($slider, 'caption')); ?></textarea></div><br class="clear">
														<div class="meta-title meta-detail-title"><?php esc_html_e('Link Type', 'crunchpress'); ?></div>
														<div class="meta-input meta-detail-input">
															<div class="combobox">
																<?php $linktype_val =  function_library::find_xml_value($slider, 'linktype'); ?>
																<select name='<?php echo esc_attr($name['linktype']); ?>[]' id='<?php echo esc_attr($name['linktype']); ?>' >
																	<option <?php echo ($linktype_val == 'No Link')? "selected" : ''; ?> ><?php esc_html_e('No Link', 'crunchpress'); ?></option>
																	<option <?php echo ($linktype_val == 'Lightbox')? "selected" : ''; ?>><?php esc_html_e('Lightbox', 'crunchpress'); ?></option>
																	<option <?php echo ($linktype_val == 'Link to URL')? "selected" : ''; ?>><?php esc_html_e('Link to URL', 'crunchpress'); ?></option>
																	<option <?php echo ($linktype_val == 'Video')? "selected" : ''; ?>><?php esc_html_e('Video', 'crunchpress'); ?></option>
																</select>
															</div>
														</div>
														<div class="url">
															<div class="meta-title meta-detail-title"><?php esc_html_e('URL Path', 'crunchpress'); ?></div> 
															<div class="meta-detail-input meta-input ml0 mt5"><input class="" type="text" name='<?php echo esc_attr($name['link']); ?>[]' id='<?php echo esc_attr($name['link']); ?>[]' value="<?php echo esc_attr(find_xml_value($slider, 'link')); ?>" /></div>
														</div>
														<br class="clear">
														<div class="video">
															<div id="video" class="meta-title meta-detail-title"><?php esc_html_e('Video URL', 'crunchpress'); ?></div> 
															<div class="meta-detail-input meta-input"><input class="" type="text" name='<?php echo esc_attr($name['video']); ?>[]' id='<?php echo esc_attr($name['video']); ?>[]' value="<?php echo esc_attr(find_xml_value($slider, 'video')); ?>" /></div>
														</div>
														<br class="clear">
														<div class="meta-detail-done-wrapper">
															<input type="button" id="cp-detail-edit-done" class="cp-button" value="Done" /><br class="clear">

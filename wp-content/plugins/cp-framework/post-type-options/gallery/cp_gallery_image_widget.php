...
?>
  ...
  <label for="<?php echo esc_attr($this->get_field_id('select_gallery')); ?>">
	  <?php esc_html_e('Select Gallery:','crunchpress');?>
  ...
  <label for="<?php echo esc_attr($this->get_field_id('nofimages')); ?>">
	 <?php esc_html_e('Number of Images to Show:','crunchpress');?> 
                ...
                <div class="flicker">
                  <ul>
						...
						$counter_limit++;
							...
							echo '<li><div class="gal-image-cp"><a data-rel="prettyPhoto[]" href="' . esc_url($image_full[0]) . '"  title=""><img src="' . esc_url($image_thumb[0]) . '" alt="' . esc_attr($alt_text) . '" /></a></div><p>'.esc_html($title).'</p></li>';
						}?>				
					</ul>
                </div>

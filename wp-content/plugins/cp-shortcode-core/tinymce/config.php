...
if(class_exists('function_library')){
	...
	$lessons = get_title_list_index('lessons');
}else{
	$team_category = array();
...
if(class_exists('EM_Events')){
	...
	$event_categories = get_category_list_index('event-categories');
...
$cp_shortcodes['heading'] = array(
	...
	'params' => array(
		...
		'style' => array(
			'type' => 'select',
			'label' => __( 'Style', 'crunchpress' ),
			'desc' => __( 'Select Heading Style', 'crunchpress' ),
			'options' => array(
				'style1' => 'Style 1',
				'style2' => 'Style 2',
				// 'style3' => 'Style 3',
		...
		'title_color' => array(
			'type' => 'colorpicker',
			'std' => '',
			'label' => __('Title Color', 'crunchpress'),
		...
		'sub_color' => array(
			'type' => 'colorpicker',
			'std' => '',
			'label' => __('Sub Heading Color', 'crunchpress'),
			'desc' => 'Leave blank for default'
		),
		
	),
	'shortcode'=>'[heading align="{{align}}" title="{{title}}" title_color="{{title_color}}" style="{{style}}" size="{{size}}" description="{{description}}" sub_color="{{sub_color}}"][/heading]',
...
$cp_shortcodes['courses'] = array(
	...
	'params' => array(
		...
		'title' => array(
			...
			'type' => 'text',
			'label' => __('Title', 'crunchpress'),
			'desc' => __('Enter Title Text To Display. ', 'crunchpress')
		),
		
		'courses_id' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Add Course Category ID', 'crunchpress'),
			'desc' => __('Please Add Course Category ID. ', 'crunchpress')
		),
		
		'number_of_courses' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Number Of Courses', 'crunchpress'),
			'desc' => __('Add Number Of Courses To Display. ', 'crunchpress')
		),
		
		
	),
	'shortcode'=>'[courses title="{{title}}" number_of_courses="{{number_of_courses}}" courses_id="{{courses_id}}"][/courses]',
	'popup_title' => __( 'Courses Shortcode', 'crunchpress' )
);

/*-----------------------------------------------------------------------------------*/
/*	Events
/*-----------------------------------------------------------------------------------*/	
$cp_shortcodes['events'] = array(
	'no_preview' => true,
	'params' => array(
		...
		'event_cat_id' => array(
			'type' => 'select',
			'label' => __('Add Event Category ID.', 'crunchpress'),
			'desc' => __('Please Add Event Category ID.', 'crunchpress'),
			'options' => $event_categories
		),	

		'scope' => array(
			'type' => 'select',
			'label' => __( 'Select Scope', 'crunchpress' ),
			'desc' => __( 'Upcoming Events, Past Events', 'crunchpress' ),
			'options' => array(
				'upcoming' => 'upcoming',
				'past' => 'past',
				'all' => 'all',
		...
		'number_of_events' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Number Of Events', 'crunchpress'),
			'desc' => __('Add Number Of Events To Display. ', 'crunchpress')
		),
		
		
	),
	'shortcode'=>'[events title="{{title}}" scope="{{scope}}" number_of_events="{{number_of_events}}" event_cat_id="{{event_cat_id}}"][/events]',
	'popup_title' => __( 'Events Gallery Shortcode', 'crunchpress' )
);

/*-----------------------------------------------------------------------------------*/
/*	Featured Lesson
/*-----------------------------------------------------------------------------------*/	
$cp_shortcodes['lesson'] = array(
	'no_preview' => true,
	'params' => array(
		...
		'title' => array(
			...
			'type' => 'text',
			'label' => __('Title', 'crunchpress'),
			'desc' => __('Enter Title Of Featured Lesson. ', 'crunchpress')
		),
		
		'lesson_id' => array(
			'type' => 'select',
			'label' => __('Add Lesson ID', 'crunchpress'),
			'desc' => __('Please Add Lesson ID You Want To Display.', 'crunchpress'),
			'options' => $lessons
		),		
	),
	'shortcode'=>'[lesson title="{{title}}" lesson_id="{{lesson_id}}"][/lesson]',
	'popup_title' => __( 'Lesson Shortcode', 'crunchpress' )
);
...
$cp_shortcodes['membership_button'] = array(
	...
	'params' => array(
		...
		'icon_bg_color' => array(
			'type' => 'colorpicker',
			'std' => '',
			'label' => __('Icon Background Color', 'crunchpress'),
			'desc' => 'Leave blank for default'
		),
		'text_bg_color' => array(
			'type' => 'colorpicker',
			'std' => '',
			'label' => __('Text Background Color', 'crunchpress'),
			'desc' => 'Leave blank for default'
		),
		...
		'border_color' => array(
			'type' => 'colorpicker',
			'std' => '',
			'label' => __('Bottom Border Color', 'crunchpress'),
			'desc' => 'Leave blank for default'
		),
	...
	'popup_title' => __( 'Membership Button  Shortcode', 'crunchpress' )
);
/*-----------------------------------------------------------------------------------*/
/*	Pricing Table
/*-----------------------------------------------------------------------------------*/	
...
$cp_shortcodes['project_facts'] = array(
	...
	'params' => array(
		...
		'count' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Title Facts Count', 'crunchpress'),
			'desc' => __('Add the Count', 'crunchpress')
		),
		'text' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Title Text', 'crunchpress'),
			'desc' => __('Write The Title Text For Fact', 'crunchpress')
		),
		
	),
	'shortcode'=>'[project_facts icon="{{icon}}" count="{{count}}" text="{{text}}"][/project_facts]',
	'popup_title' => __( 'Project_Facts', 'crunchpress' )
);
...
$cp_shortcodes['title'] = array(
	...
	'params' => array(
		...
		'color' => array(
			'type' => 'colorpicker',
			'std' => '',
			'label' => __('Select Color For Heading', 'crunchpress'),
			'desc' => __( 'Set Color Of Heading Text.', 'crunchpress' ),
		),
	...
	'shortcode'=>'[title size="{{size}}" color="{{color}}"]{{content}}[/title]',

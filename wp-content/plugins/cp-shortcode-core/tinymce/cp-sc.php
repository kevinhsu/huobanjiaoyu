...
-->
			<?php			
				$select_shortcode = array(
					...
					'17' => array('name' =>'Heading Style','slug' => 'heading','icon' => 'fa fa-header'),
					...
					'42' => array('name' =>'Project Facts','slug' => 'project_facts','icon' => 'fa fa-info-circle'),
					'43' => array('name' =>'Membership Button','slug' => 'membership_button','icon' => 'fa fa-user'),
					'44' => array('name' =>'Courses','slug' => 'courses','icon' => 'fa fa-book'),
					'45' => array('name' =>'Free Lesson','slug' => 'lesson','icon' => 'fa fa-puzzle-piece'),
					'46' => array('name' =>'Events','slug' => 'events','icon' => 'fa fa-info'),

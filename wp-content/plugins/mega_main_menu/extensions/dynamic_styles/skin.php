...
#mega_main_menu' . $location_class . ' li.post_type_dropdown > .mega_dropdown > li > .item_link:hover,
...
#mega_main_menu' . $location_class . ' li.grid_dropdown > .mega_dropdown > li > .item_link:hover,

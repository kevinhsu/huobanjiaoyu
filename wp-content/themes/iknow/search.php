		...
		<div class="container">						
			<?php if (is_category()) { ?>
				...
				<?php }elseif (is_search()) { ?>
					<h2 class="h-style"><?php esc_html_e('Search results for', 'crunchpress'); ?> : <?php echo esc_html(get_search_query()) ?></h2>
				<?php } elseif (is_tag()) { ?>
    	...
    	<div class="container">
            ...
            <div class="main-content main-content-area">
				...
				<div class="single_content row-fluid">
					...
					<?php } ?>
					<div id="<?php the_ID(); ?>" class="<?php echo esc_attr($sidebar_class[1]);?> blog_listing blog_post_detail cp-blog">
						<div <?php post_class(); ?>>
								<?php if (is_author()) { ?>
										<!--<h2 class="heading"><?php esc_html_e('Archive by Author', 'crunchpress'); ?></h2><span class="border-line m-bottom"></span>-->
									<?php 
									if ( have_posts() ) {
										the_post();?>
										<div class="clear"></div>
										...
										<div class="about-admin">
											<div class="thumb">
												<?php echo esc_html(get_avatar(get_the_author_meta( 'ID' )));?>
											</div>
											<div class="text">
												...
												<div class="share-it">
													...
													<?php 
														...
														$gplus = esc_url(get_the_author_meta('gplus'));
														$linked = esc_url(get_the_author_meta('linked'));
								...
								<div <?php post_class($item_class); ?>>
									<div class="blog_cp-contant">
										...
										<?php if(print_blog_thumbnail($post->ID,array(1600,900)) <> ''){ ?>
											<div class="thumb">
										...
										<div class="blog_cp-comments">
											<a href="<?php echo esc_url(get_permalink());?>"><i class="fa fa-user"></i><?php echo esc_html(get_the_author());?></a>
								...
								//Condition Ends
									...
									echo '<h4>'.esc_html__('No Match Found','crunchpress').'</h4>';
									echo '<p>'.esc_html__('Please try with another keyword','crunchpress').'</p>';
								}
								//Pagination
								pagination();
							?>

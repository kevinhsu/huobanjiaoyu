...
<div id="wrapper_backend cp-margin-left">
	<div id="header_theme_options">	<span id="backend_logo"> <h1> <a href="#"><h3> <?php esc_html_e('CrunchPress Framework','crunchpress');?> </h3>
  </a> </h1> </span>
	</div>
	<div class="wrapper_1">
		<?php echo esc_html(top_navigation_html());?>		
	</div>
	<div class="below_wrapper tabs">
		<div class="wrapper_left">
			<ul id="wp_t_o_right_menu">
				<li class="home_layout" id="active_tab"><?php esc_html_e('Home Page Layout', 'crunchpress'); ?></li>
   				<li class="footer_area"><?php esc_html_e('Footer Layout', 'crunchpress'); ?></li>
			</ul>
		</div>
			...
			<form id="options-panel-form" name="cp-panel-form">
				<div class="panel-elements" id="panel-elements">
					<div class="panel-element" id="panel-element-save-complete">
						<div class="panel-element-save-text"><?php esc_html_e('Save Options Complete', 'crunchpress'); ?>.</div>
						<div class="panel-element-save-arrow"></div>
					</div>
					<ul>
						<li id="home_layout" class="active_tab">
							<h3> <?php esc_html_e('Home Page Layout Settings','crunchpress');?> </h3>

							<ul class="panel-body recipe_class">
								<li class="panel-title">
									<label for="" > <?php esc_html_e('News Headline', 'crunchpress'); ?> </label>
								</li>	
								...
								<li class="description"><h3> <?php esc_html_e('You can turn On/Off Home Page Widgets from Top of the page.','crunchpress');?> </h3>
</li>
							</ul>
                            <div class="clear"></div>
                            <ul class="panel-body recipe_class">
                                <li class="panel-title">
                                    <label for="header_headline" > <?php esc_html_e('News Headline Title', 'crunchpress'); ?> </label>
                                </li>	
                                <li class="panel-input">
                                ...
                                <li class="description"><h3> <?php esc_html_e('Please enter your news headline title here.','crunchpress');?> </h3>
</li>
                            </ul>
							<div class="clear"></div>
							<ul class="panel-body recipe_class">

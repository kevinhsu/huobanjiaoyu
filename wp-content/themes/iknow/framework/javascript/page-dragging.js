...
jQuery(document).ready(function () {
    ...
    var DIV_SIZE = [
        ...
        ['1/3', 'element1-3', 1 / 3, ['Services','Sidebar','Column', 'Gallery', 'Contact-Form', 'Content','Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ['1/2', 'element1-2', 1 / 2, ['Client-Slider','News','Services','Sidebar','Contact-Form', 'Column', 'Gallery',  'Single-Album','Content','Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ['2/3', 'element2-3', 2 / 3, ['Client-Slider','Sidebar','Event-Calendar','Events','Music-Gallery','Services','Column', 'Gallery', 'Contact-Form', 'Content', 'Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ...
        ['1/1', 'element1-1', 1, ['Latest-News','Crowd-Funding','Courses','Feature-Projects','Woo-Products','Next-Events','Sidebar','Client-Slider','Services', 'Column', 'Gallery', 'Content', 'Blog','Events','Music-Gallery', 'News', 'Albums', 'Slider', 'Accordion', 'Tab', 'Divider', 'Message-Box', 'Toggle-Box', 'Contact-Form','Carousel']],
    ];
	...
	// Inside Condition for hide and show elements of Team
    jQuery("div.combobox #page-option-attachment-bg-cp").change(function () {
        var image_parallax_class = jQuery(this).parents(".meta-body").parent().siblings().find('.image-class-parallax');
        if (jQuery(this).val() == 'Parallax') {
			image_parallax_class.parent().removeClass('default-slider-hide');
        }else{
			image_parallax_class.parent().addClass('default-slider-hide');
		}
    });
	
	// Inside Condition for hide and show elements of Team On Load
    jQuery("div.combobox #page-option-attachment-bg-cp").each(function () {
		var image_parallax_class = jQuery(this).parents(".meta-body").parent().siblings().find('.image-class-parallax');
        if (jQuery(this).val() == 'Parallax') {
			image_parallax_class.parent().removeClass('default-slider-hide');
        }else{
	...
	// Filterable Condition for PRoduct Option
    jQuery("div.combobox #page-option-item-course-filterable").change(function () {
        var cp_product_listing = jQuery(this).parents(".meta-body").parent().parent().find(".course-filterable-item");
        if (jQuery(this).val() == 'No') {
            cp_product_listing.parent().removeClass('default-slider-hide');
        } else {
             cp_product_listing.parent().addClass('default-slider-hide');
        }
    });
    jQuery("div.combobox #page-option-item-course-filterable").each(function () {
        var cp_product_listing = jQuery(this).parents(".meta-body").parent().parent().find(".course-filterable-item");
        if (jQuery(this).val() == 'No') {
            cp_product_listing.parent().removeClass('default-slider-hide');
        } else {

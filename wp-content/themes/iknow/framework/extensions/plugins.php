...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> 'http://crunchpress.net/dev/localdirectory/LayerSlider.zip', // The plugin source
		...
		array(
			'name'     				=> 'Taqeem Rating Plugin', // The plugin name
			'slug'     				=> 'taqyeem', // The plugin slug (typically the folder name)
			//'source'   				=> get_stylesheet_directory() . '/framework/extensions/plugins/wordpress-importer.zip', // The plugin source
			'source'   				=> 'http://crunchpress.net/dev/localdirectory/taqyeem.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			...
			//'source'   				=> get_stylesheet_directory() . '/framework/extensions/plugins/wordpress-importer.zip', // The plugin source
			'source'   				=> 'http://crunchpress.net/dev/localdirectory/mega_main_menu.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins

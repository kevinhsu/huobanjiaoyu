...
*/
	...
	global $current_user; ?>
		...
		<header>
			...
			<!--TOP STRIP END-->
			<?php if ( !class_exists( 'mega_main_init' ) ) { //Condition for Plug-in if available ends ?>
				<!--NAVIGATION START-->
					...
					<div class="container">
						<div class="logo">
							...
							<a href="<?php echo esc_url(home_url()); ?>">
								<img class="logo_img" width="<?php if($logo_width == '' or $logo_width == ' '){ echo '239'; }else{echo $logo_width;}?>" height="<?php if($logo_height == '' or $logo_height == ' '){ echo ''; }else{echo $logo_height;}?>" src="<?php if($image_src <> ''){echo $image_src;}else{echo esc_url(CP_PATH_URL.'/images/logo.png');}?>" alt="<?php echo bloginfo( 'name' )?>">
							</a>
						</div>
			...
			} //Condition for Plugin If Available Ends
			?>
		</header>
		<!--HEADER END-->
	<?php 
	...
	function header_style_2(){ ?>
			...
			<?php if(!has_nav_menu('main-menu')){ ?>
				<div class="side-nav-container">
					<a id="no-show-menu-cp" class="menu_show_cp">
						<i class="fa fa-bars"></i>
					</a>
					<div class="cp-menu-con-logo">
						<div class="logo">
							<?php 
							$header_logo = get_themeoption_value('header_logo','general_settings');
							$logo_width = get_themeoption_value('logo_width','general_settings');
							...
							<a href="<?php echo home_url(); ?>">
								<img class="logo_img" width="<?php if($logo_width == '' or $logo_width == ' '){ echo '239'; }else{echo $logo_width;}?>" height="<?php if($logo_height == '' or $logo_height == ' '){ echo ''; }else{echo $logo_height;}?>" src="<?php if($image_src <> ''){echo $image_src;}else{echo CP_PATH_URL.'/images/logo.png';}?>" alt="<?php echo bloginfo( 'name' )?>" />
							</a>
						</div>
			...
			<?php 
			}else{ //Mega Menu Plugin Code
				if(has_nav_menu('main-menu')){ //Default Menu Found
					echo '<div class="navigation-bar"><div class="container">';
						$defaults = array(
						  'theme_location'  => 'main-menu',
						  'menu'            => '', 
				...
				echo '
					<div class="side-nav-container"><a id="no-show-menu-cp" class="menu_show_cp">
						<i class="fa fa-bars"></i>
					</a>';
					...
					echo '</div>';
				echo '</div>';		
				} // If Sidebar Menu Found
			} //End Condition for Default Menu and Mega Menu Plugin
	} 
				...
				<div class="navbar margin-none">
					...
					<div class="search-box">
						<form method="get" action="<?php  echo home_url(); ?>/">
							<input name="" type="text" class="top-search-input" placeholder="Search for..." value="<?php the_search_query(); ?>">
